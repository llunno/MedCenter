      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
          ...
          <div class="div-buttons">
              <router-link class="btn btn-success text-light" to="/login">Cadastre-se</router-link>
              <router-link type="button" class="btn btn-success text-light" to="/signup">Log-in</router-link>
          </div>
        </div>
      </div>
    </nav>
