<template>
    <div>
      ...
      <nav class="nav">
        ...
        <button v-on:click="clearRoutes()">Limpar rota</button>
      </nav>
  ...
  export default {
    data() {
      return {
        ...
        service: null,
        locations: [
          { name: "Hospital Vita", loc: { lat: -25.40655388182551, lng: -49.21713757604011 } },
          { name: "Hospital Santa Madalena Sofia", loc: { lat: -25.416609576502722, lng: -49.22078560542964 } },
          { name: "Hospital do Trabalhador", loc: { lat: -25.481037740847373, lng: -49.295378514218704 } },
        ],
        fromLocation: "",
        toLocation: "",
      };
