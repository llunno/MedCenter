<template>
	<main class="container-fluid d-flex flex-column align-items-center justify-content-center" id="containerEnderecos">
		...
		<section id="manageEnderecos" class="container-fluid d-flex gap-2 mx-auto justify-content-center">
			<div id="actualEndereco" class="card p-2 justify-content-center m-2 cards-endereco">
			...
			<div id="newEndereco" class="card p-4 text-center justify-content-center m-2 cards-endereco">
		...
		<section id="manageHorarios"
			class="d-flex text-center justify-content-center m-2 align-items-center gap-4 mb-5 my-5">
			<div id="startHorario" class="d-flex align-items-center justify-content-center gap-2" tabindex="0">
				<p class="m-0 p-card-item">De</p>
				<input id="dateInputEnderecos" class="form-control" type="datetime-local" v-model="this.hora_de" />
			</div>
			<div id="endHorario" class="d-flex align-items-center justify-content-center gap-2" tabindex="0">
				<p class="m-0 p-card-item">Até</p>
				<input id="dateInputEnderecos" class="form-control" type="datetime-local" v-model="this.hora_ate" />
			</div>
		</section>
		<button id="confirmarEnderecoBtn" class="btn btn-primary mb-4" @click.prevent="selectHorario"
			tabindex="0">Confirmar</button>
	</main>
</template>
<script>
